    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mac_addr', MACAddressFieldUnixDialect(unique=True, verbose_name='Mac address')),
                ('comment', models.CharField(max_length=256, verbose_name='Comment')),
                ('devtype', models.PositiveSmallIntegerField(choices=[(1, 'DLink switch'), (2, 'PON OLT'), (3, 'PON ONU BDCOM'), (4, 'Eltex switch'), (5, 'OLT ZTE C320'), (6, 'Zte ONU F660'), (7, 'Zte ONU F601'), (8, 'Huawei switch')], db_column='dev_type', default=1, verbose_name='Device type')),
